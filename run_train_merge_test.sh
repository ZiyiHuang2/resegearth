...
export WANDB_NAME=base-siglip1-28w
...
# Output
########################################
OUTPUT_DIR="/home/wangchengjun/huangziyi/reseg/output/base/standard-base-siglip1-28w"
...
EVAL_WANDB_RUN_NAME="base-siglip1-28w"
