...
class SegEarthR2(MiphaPhiForCausalLM):
    ...
    def eval_seg(self, input_ids: torch.LongTensor = None, attention_mask: Optional[torch.Tensor] = None, past_key_values: Optional[List[torch.FloatTensor]] = None, inputs_embeds: Optional[torch.FloatTensor] = None, labels: Optional[torch.LongTensor] = None, use_cache: Optional[bool] = None, output_attentions: Optional[bool] = None, output_hidden_states: Optional[bool] = None, images: Optional[torch.FloatTensor] = None, images_clip: Optional[torch.FloatTensor] = None, return_dict: Optional[bool] = None, seg_info=None, token_refer_id=None, clip_prior_text=None, kb_text=None, kb_text_token_id=None, kb_visual_feat=None, SEG_token_embedding_indices=None, mask_num=None):
        ...
        for _seg_info, mask_pred_result in zip(seg_info, mask_pred_results):
            processed_results.append({'pred': ((mask_pred_result.detach().float().cpu().numpy() > 0) * 255).astype(np.uint8), 'image_name': _seg_info['image_id'], 'id': _seg_info['data_id'], 'mask_id': _seg_info['mask_id']})
