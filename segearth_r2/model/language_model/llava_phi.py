...
class SegEarthR2(MiphaPhiForCausalLM):
    ...
    def forward(
        ...
        SET_embedding = self.SET_token_projector(self.get_SET_embedding(hidden_states, SET_token_embedding_indices))
    ...
    def eval_seg(
        ...
        mask_pred_results = mask_outputs["pred_masks"]  # [B, 1+Kmax, H, W]
